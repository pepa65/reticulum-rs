...
impl TcpServer {
	pub fn new<T: Into<String>>(addr: T, iface_manager: Arc<tokio::sync::Mutex<InterfaceManager>>) -> Self {
	...
	pub async fn spawn(context: InterfaceContext<Self>) {
		...
		loop {
			...
			let listener = TcpListener::bind(addr.clone()).await.map_err(|_| RnsError::ConnectionError);
