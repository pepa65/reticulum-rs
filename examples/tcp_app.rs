use rand_core::OsRng;
use reticulum::destination::{DestinationAnnounce, DestinationName, SingleInputDesination};
...
async fn main() {
    ...
    let destination = SingleInputDesination::new(id, DestinationName::new("example", "app"));
